# Common and no common fields of  Italian, German, English, FDA - USDA, Greek, Spanish Database

|  |  | German database | English database | Italian database | FDA - USDA | Greek database | Spanish database |
|---|---|---|---|---|---|---|---|
| 1 | Food Name (EN) | x | x | x | x | x | x |
| 2 | Food Code |  | x |  |  | | x |
| 3 | Description |  | x |  |  | | |
| 4 | Group |  | x |  |  | | x |
| 5 | Previous |  | x |  |  | | |
...
| 18 | Cholesterol (mg) | x | x |  x | x | | x |
| 19 | Ash (g) |  |  |  | x | | |
| 20 | Energy (kcal) | x | x | x | x | x| x |
| 21 | Energy, Rec with fibre (kcal) | x |  | x | | | |
| 22 | Energy (kJ) | x  | x | x | | | |
| 23 | Energy, Rec with fibre (kJ) | x |  | x | | | |
| 24 | Fat (mg) | x | x (in g) | x (in g - Total fat) | x (Total lipid) |  x (Total lipids) | x (in g)|
| 25 | Animal Fat (g) |  |  | x | | | |
| 26 | Vegetable Fat (g) |  |  | x | | | |
| 27 | Carbohydrates (mg) | x | x (in g) | x (in g) | x (in g - from Available carbohydrate)| x (in g) | x (in g) |
| 28 | ~~Available carbohydrates (MSE) (g)~~ |  | | ~~x~~ | |  | |
| 29 | Soluble carbohydrates (MSE) (g) |  |  | x | | | |
| 30 | Protein (mg) | x | x (in g) | x (in g - Total protein) | x (in mg) | x (in g) | x (in g) |
...
| 108 | Vitamin B3, Niacin, nicotinic acid (µg)| x |  |  | | | x (in mg) |
...
| 144 | Palmitoleic acid (g)| x (in mg - Hexadecenoic acid / Palmitoleic acid) |  | | x | | x (in mg)|
...
| 181 | Omega-3 fatty acids (mg) | x |  |  | | | x (Omega 3)|
